...
CREATE TABLE if not exists if not exists `app` (
  ...
  `modify_time` datetime(3) COMMENT '修改时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE if not exists if not exists `authority` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `app_id` varchar(128) NOT NULL DEFAULT '' COMMENT '应用id',
...
)  DEFAULT CHARSET=utf8 COMMENT='权限信息(kafka-manager)';
...
CREATE TABLE if not exists if not exists `broker` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
)  DEFAULT CHARSET=utf8 COMMENT='broker信息表';
...
)  DEFAULT CHARSET=utf8 COMMENT='broker-metric信息表';
...
CREATE TABLE if not exists `cluster` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '集群id',
...
)  DEFAULT CHARSET=utf8 COMMENT='cluster信息表';
...
)  DEFAULT CHARSET=utf8 COMMENT='clustermetrics信息';
...
CREATE TABLE if not exists `cluster_tasks` (
  ...
  `modify_time` datetime(3) COMMENT '修改时间',
  PRIMARY KEY (`id`)
)  DEFAULT CHARSET=utf8 COMMENT='集群任务(集群升级部署)';
...
)  DEFAULT CHARSET=utf8 COMMENT='controller记录表';
...
CREATE TABLE if not exists `gateway_config` (
  ...
  `version` bigint(20) NOT NULL DEFAULT '0' COMMENT '版本信息',
  `create_time` datetime(3) COMMENT '创建时间',
  `modify_time` datetime(3) COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_type_name` (`type`,`name`)
)  DEFAULT CHARSET=utf8 COMMENT='gateway配置';
...
)  DEFAULT CHARSET=utf8 COMMENT='心跳信息';
...
CREATE TABLE if not exists `kafka_acl` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  ...
  `create_time` datetime(3) COMMENT '创建时间',
  PRIMARY KEY (`id`)
)  DEFAULT CHARSET=utf8 COMMENT='权限信息(kafka-broker)';
...
CREATE TABLE if not exists `kafka_bill` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `cluster_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '集群id',
  `topic_name` varchar(192) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT 'topic名称',
...
)  DEFAULT CHARSET=utf8 COMMENT='kafka账单';
...
CREATE TABLE if not exists `kafka_file` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `cluster_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '集群id',
...
)  DEFAULT CHARSET=utf8 COMMENT='文件管理';
...
CREATE TABLE if not exists `kafka_user` (
  ...
  `create_time` datetime(3) COMMENT '创建时间',
  PRIMARY KEY (`id`)
)  DEFAULT CHARSET=utf8 COMMENT='kafka用户表';
...
CREATE TABLE if not exists `logical_cluster` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_name` (`name`)
)  DEFAULT CHARSET=utf8 COMMENT='逻辑集群信息表';
...
CREATE TABLE if not exists `monitor_rule` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_name` (`name`)
)  DEFAULT CHARSET=utf8 COMMENT='监控规则';
...
)  DEFAULT CHARSET=utf8 COMMENT='操作记录';
...
CREATE TABLE if not exists `reassign_task` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  ...
  `begin_time` datetime(3) COMMENT '开始时间',
  `operator` varchar(64) NOT NULL DEFAULT '' COMMENT '操作人',
  `description` varchar(256) NOT NULL DEFAULT '' COMMENT '备注说明',
  `status` int(16) NOT NULL DEFAULT '0' COMMENT '任务状态',
  `gmt_create` datetime(3) COMMENT '任务创建时间',
  `gmt_modify` datetime(3) COMMENT '任务修改时间',
  ...
  PRIMARY KEY (`id`)
)  DEFAULT CHARSET=utf8 COMMENT='topic迁移信息';
...
CREATE TABLE if not exists `region` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_name` (`name`)
)  DEFAULT CHARSET=utf8 COMMENT='region信息表';
...
)  DEFAULT CHARSET=utf8 COMMENT='topic信息表';
...
CREATE TABLE if not exists `topic_app_metrics` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `cluster_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '集群id',
  `topic_name` varchar(192) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT 'topic名称',
  `app_id` varchar(64) NOT NULL DEFAULT '' COMMENT 'appid',
  ...
  KEY `idx_gmt_create` (`gmt_create`)
)  DEFAULT CHARSET=utf8 COMMENT='topic app metrics';
...
)  DEFAULT CHARSET=utf8 COMMENT='topic连接信息表';
...
CREATE TABLE if not exists `topic_expired` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `cluster_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '集群id',
  `topic_name` varchar(192) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT 'topic名称',
  ...
  `gmt_retain` datetime(3) COMMENT '保留截止时间',
  `status` int(16) NOT NULL DEFAULT '0' COMMENT '-1:可下线, 0:过期待通知, 1+:已通知待反馈',
  `gmt_create` datetime(3) COMMENT '创建时间',
  `gmt_modify` datetime(3) COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_cluster_id_topic_name` (`cluster_id`,`topic_name`)
)  DEFAULT CHARSET=utf8 COMMENT='topic过期信息表';
...
CREATE TABLE if not exists `topic_metrics` (
  ...
  KEY `idx_gmt_create` (`gmt_create`)
)  DEFAULT CHARSET=utf8 COMMENT='topicmetrics表';
...
CREATE TABLE if not exists `topic_report` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `cluster_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '集群id',
  `topic_name` varchar(192) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT 'topic名称',
  `start_time` datetime(3) COMMENT '开始上报时间',
  `end_time` datetime(3) COMMENT '结束上报时间',
  `create_time` datetime(3) COMMENT '创建时间',
  `modify_time` datetime(3) COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_cluster_id_topic_name` (`cluster_id`,`topic_name`)
)  DEFAULT CHARSET=utf8 COMMENT='开启jmx采集的topic';
...
CREATE TABLE if not exists `topic_request_time_metrics` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `cluster_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '集群id',
  `topic_name` varchar(192) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT 'topic名称',
  `metrics` text COMMENT '指标',
  ...
  KEY `idx_cluster_id_topic_name_gmt_create` (`cluster_id`,`topic_name`,`gmt_create`),
  KEY `idx_gmt_create` (`gmt_create`)
)  DEFAULT CHARSET=utf8 COMMENT='topic请求耗时信息';
...
CREATE TABLE if not exists `topic_statistics` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_cluster_id_topic_name_gmt_day` (`cluster_id`,`topic_name`,`gmt_day`)
)  DEFAULT CHARSET=utf8 COMMENT='topic统计信息表';
...
CREATE TABLE if not exists `topic_throttled_metrics` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `cluster_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '集群id',
  ...
  KEY `idx_gmt_create` (`gmt_create`)
)  DEFAULT CHARSET=utf8 COMMENT='topic限流信息';
...
CREATE TABLE if not exists `work_order` (
  ...
  `gmt_handle` datetime(3) COMMENT '审批时间',
